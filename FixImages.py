...
print("and can be deleted after this process, or you can elect to delete them during the")
...
while not isValidDirectory:
    directory = input("Enter full directory containing png and svg files: ")
    ...
    if os.path.exists(directory): # check to see if directory exists before proceeding
        isValidDirectory = True # if valid directory, flag this to true to prevent next loop iteration
    else: # complain
        print("")
